        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-screen lg:min-h-0 lg:py-32">
          ...
          <div className="hidden lg:flex justify-center lg:justify-end">
            <div className="relative w-full max-w-sm">
              ...
              {/* Status badge */}
              <div className="absolute top-5 right-5 flex items-center gap-1.5 bg-green-500/90 backdrop-blur-sm border border-green-400/30 rounded-full px-3 py-1.5 text-white text-xs font-semibold shadow-lg">
